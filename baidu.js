window.TILE_VERSION = {
  ditu: {
    normal: { version: "088", updateDate: "20200120" },
    satellite: { version: "009", updateDate: "20200120" },
    normalTraffic: { version: "081", updateDate: "20200120" },
    satelliteTraffic: { version: "083", updateDate: "20200120" },
    mapJS: { version: "104", updateDate: "20200120" },
    satelliteStreet: { version: "083", updateDate: "20200120" },
    earthVector: { version: "001", updateDate: "20200120" }
  },
  webapp: {
    high_normal: { version: "001", updateDate: "20200120" },
    lower_normal: { version: "002", updateDate: "20200120" }
  },
  api_for_mobile: {
    vector: { version: "002", updateDate: "20200120" },
    vectorIcon: { version: "002", updateDate: "20200120" }
  }
};
...
(function() {
  ...
  /msie (\d+\.\d)/i.test(navigator.userAgent) &&
    (x.da.la = x.la = document.documentMode || +RegExp.$1);
  var ja = {
  ...
  x.K.ha = function(a) {
    ...
    if (a.getBoundingClientRect) {
      ...
      if (c.opera > 0 || (c.pM > 0 && d(a, "position") == "absolute"))
  ...
  x.XK = (function() {
    function a(a) {
      document.addEventListener &&
        ((this.element = a),
        (this.$K = this.zk ? "touchstart" : "mousedown"),
        (this.qD = this.zk ? "touchmove" : "mousemove"),
        (this.pD = this.zk ? "touchend" : "mouseup"),
        (this.oh = q),
        (this.ju = this.iu = 0),
        this.element.addEventListener(this.$K, this, q),
        ia.M(this.element, "mousedown", s()),
        this.handleEvent(p));
    }
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 <
            Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.iu) ||
  ...
  z.ZU =
    ...
    function() {
      z.version &&
        z.version >= 1.5 &&
        oa(z.qc + "?qt=verify&ak=" + pa, function(a) {
          if (a && a.error !== 0) {
  ...
  function Ka(a, b) {
    if ((a = x.$(a))) {
      ...
      c.Xu();
      c.R = { Hc: q, lc: 0, up: 0, uM: 0, r3: 0, dC: q, cF: -1, Qe: [] };
      ...
      Ua() &&
        I.load("oppc", function() {
          c.vz();
        });
      G() &&
        I.load("opmb", function() {
          c.vz();
        });
      a = p;
      c.NB = [];
  ...
  x.extend(Ka.prototype, {
    ...
    hk: function(a, b, c, d) {
      ...
      if ((c = c && d ? f.Ck(c, this.Xb) : this.mc))
        if (
          ((this.mc = new H(c.lng + a * e, c.lat - b * e)),
          (a = f.nh(this.mc, this.Xb)) && g)
        )
          this.Oe = a;
    },
    Cg: function(a, b) {
    ...
    ui: function(a) {
      a instanceof H &&
        ((this.mc = this.ie.Ck(a, this.Xb)),
        (this.Oe = H.hM(a)
          ? new H(a.lng, a.lat)
          : this.ie.nh(this.mc, this.Xb)));
    },
    wg: function(a, b) {
      a = Math.round(a) || 0;
      b = Math.round(b) || 0;
    ...
    as: function(a) {
      a &&
        Xa(a.Ge) &&
        (a.Ge(this), this.dispatchEvent(new M("onaddcontrol", a)));
    },
    EN: function(a) {
      a &&
        Xa(a.remove) &&
    ...
    Ka: function(a) {
      a &&
        Xa(a.Ge) &&
        (a.Ge(this), this.dispatchEvent(new M("onaddoverlay", a)));
    },
    Ub: function(a) {
      a &&
        Xa(a.remove) &&
      ...
      if (a instanceof H) b.ui(a, { noAnimation: o });
        ...
        if (b.Jb === Pa) {
          ...
          d.yF(function(c) {
            0 === d.Am() &&
              2 === d.Fa.result.type &&
              (b.Vf(c.xk(0).point), Pa.tk(a) && b.sF(a));
          });
      ...
      if (Za(a))
        if (c.Jb === Pa) {
          ...
          e.yF(function(d) {
            if (
              0 === e.Am() &&
              (2 === e.Fa.result.type || 11 === e.Fa.result.type)
            ) {
              var d = d.xk(0).point,
    ...
    Po: function() {
      this.C.Po = o;
      this.Mn || ((this.Mn = new bb({ dL: o })), this.Vg(this.Mn));
    },
    jW: function() {
      this.C.Po = q;
    ...
    Bb: function() {
      return this.vs && this.vs instanceof L
        ? new L(this.vs.width, this.vs.height)
        : new L(this.Va.clientWidth, this.Va.clientHeight);
    },
    Ae: function(a) {
      a && a instanceof L
        ? ((this.vs = a),
          (this.Va.style.width = a.width + "px"),
          (this.Va.style.height = a.height + "px"))
        : (this.vs = p);
    },
    Ha: u("Oe"),
    fa: u("Oa"),
    ...
    N3: function(a, b) {
      ...
      this.Jb === Pa &&
        c &&
        ((a.x += this.offsetX), (a.y += this.offsetY), cb.qK(a, this, b));
    },
    Hd: function(a) {
    ...
    Vt: function(a) {
      ...
      if (a) {
        ...
        a.style &&
          (c = b.C.hm[a.style]
            ? b.C.hm[a.style].backColor
            : b.C.hm.normal.backColor) &&
    ...
    cM: function(a) {
      a
        ? (this.rs && this.rs.zf === a) ||
          (this.wh(this.rs),
          (this.rs = new lb({ geotableId: a })),
          this.Vg(this.rs))
        : this.wh(this.rs);
    },
    Wb: function() {
    ...
    getCurrentCity: function() {
      return { name: this.Xg, code: this.ds };
    },
    xm: function() {
      this.P.bo();
      return this.P;
  ...
  z.$_ = {
    "0": { proto: "http://", domain: z.bY },
    1: { proto: "https://", domain: z.XL },
    2: { proto: "https://", domain: z.XL }
  };
  ...
  function qb(a) {
    var b = { duration: 1e3, Gc: 30, Lo: 0, jc: rb.CM, Gt: s() };
    this.Yf = [];
  ...
  function tb(a) {
    var b = $a();
    b >= a.Zz
      ? (Xa(a.k.va) && a.k.va(a.k.jc(1)),
        Xa(a.k.finish) && a.k.finish(),
        0 < a.Yf.length &&
          ((b = a.Yf[0]), (b.Yf = [].concat(a.Yf.slice(1))), b.start()))
      : ((a.zy = a.k.jc((b - a.Ou) / a.k.duration)),
        Xa(a.k.va) && a.k.va(a.zy),
        a.HF ||
  ...
  var F = {
    ...
    bP: 73,
    hC: {
      北京: { oy: "bj", m: new H(116.403874, 39.914889) },
      上海: { oy: "sh", m: new H(121.487899, 31.249162) },
      深圳: { oy: "sz", m: new H(114.025974, 22.546054) },
      广州: { oy: "gz", m: new H(113.30765, 23.120049) }
    },
  ...
  x.da.Se
    ? (x.extend(F, {
      ...
      x.platform.qM && (F.fontFamily = "arial,simsun,sans-serif"))
    : x.da.Iw || x.da.kF
    ? x.extend(F, {
  ...
  z.jq = { qG: "#83a1ff", lq: "#808080" };
  function Ob(a, b, c) {
    b.Pm || ((b.Pm = []), (b.handle = {}));
    b.Pm.push({ filter: c, rm: a });
    b.addEventListener ||
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Pb(b.Pm, function(b, g) {
              RegExp(g.filter).test(c.getAttribute("filter")) &&
                g.rm.call(c, a, c.getAttribute("filter"));
            });
            c = c.parentNode;
          }
        },
  ...
  void (function(a, b, c) {
    void (function(a, b, c) {
      ...
      function w(a) {
        this.name = a;
        this.Ns = { protocolParameter: { postUrl: p, protocolParameter: p } };
        this.XJ = [];
        this.alog = P;
      }
      function y(a) {
      ...
      if (!B || !B.Ko) {
        var A = b.all && a.attachEvent,
          ...
          N = {},
          Q = {},
          Z = { v1: { name: "alog", Ko: o, Kc: P } };
        w.prototype.start = w.prototype.create = function(a) {
          if (!this.xK) {
            "object" == typeof a && this.set(a);
            this.xK = new Date();
            for (this.Os("create", this); (a = this.XJ.shift()); )
              t.apply(this, a);
          }
        };
        w.prototype.send = function(a, b) {
          var c = v({ ts: i().toString(36), t: a, sid: C }, this.Ns);
        ...
        w.prototype.set = function(a, b) {
          if ("string" == typeof a)
            "protocolParameter" == a &&
              (b = v({ postUrl: p, protocolParameter: p }, b)),
              (this.Ns[a] = b);
      ...
      if (t && t.xh && k() < t.xh) {
        var A = ["Moz", "O", "ms", "Webkit"],
          ...
          ii = function() {
            return (
              !!b.createElementNS &&
              !!b.createElementNS("http://www.w3.org/2000/svg", "svg").N1
            );
          },
          ji = function() {
            return !!a.J0;
          ...
          ti = function() {
            return !(
              !Z("exitFullscreen", b, q) && !Z("cancelFullScreen", b, q)
            );
          },
          ui = function() {
            return !!Z("Intl", a);
        ...
        v.M("commit", function() {
          ...
          var a = setInterval(function() {
            if (
              "WebP-lossy" in Mb.ii &&
              "WebP-lossless" in Mb.ii &&
              "WebP-alpha" in Mb.ii &&
              "WebP-animation" in Mb.ii
            ) {
        ...
        c.alog("feature.create", { Y1: 4, R3: i, page: g, ub: "18" });
  ...
  x.object.extend(I, {
    ...
    U3: {},
    kG: { bQ: z.ma + "getmodules?v=2.0&t=20140707", CU: 5e3 },
    EC: q,
    Pd: { vl: {}, Gn: [], Vv: [] },
    load: function(a, b, c) {
      var d = this.ib(a);
    ...
    nK: function(a) {
      if (a && this.tL()[a])
        for (var a = this.tL()[a], b = 0; b < a.length; b++)
          this.nK(a[b]), this.Pd.vl[a[b]] || this.BN(a[b]);
    },
    BN: function(a) {
    ...
    xV: function(a, b) {
      for (var c = this.Pd.Vv, d = o, e = 0, f = c.length; e < f; e++)
        "" == c[e].ME && (c[e].VM == a ? (c[e].ME = b) : (d = q));
      d && this.ZK();
    },
    ZK: function() {
      for (var a = this.Pd.Vv, b = 0, c = a.length; b < c; b++)
        this.CZ(a[b].VM, a[b].ME);
      this.Pd.Vv.length = 0;
    }
  });
  function R(a, b) {
  ...
  function gb(a, b) {
    a &&
      ...
      (b = b || {}),
      (this.Sg = b.text || ""),
      (this.Bv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5]),
      (this.wJ = b.userData || p),
      (this.Qh = b.minZoom || p),
      (this.Ef = b.maxZoom || p));
  }
  gb.ba = 0;
  ...
  x.extend(Sb.prototype, {
    ...
    Ge: function(a) {
      !this.B &&
        this.initialize && Xa(this.initialize) &&
        (this.B = this.initialize(a));
      this.k = this.k || { yg: q };
      this.zB();
      this.Or();
    ...
    rc: function(a) {
      if (this.w1 || !Wa(a) || isNaN(a) || a < Tb || 3 < a)
    ...
    Xe: function(a) {
      a instanceof L &&
        ((this.k = this.k || { yg: q }),
        (this.k.za = new L(a.width, a.height)),
        this.B && this.rc(this.k.anchor));
    },
    Pf: function() {
      return this.k.za;
    },
  ...
  x.object.extend(Xb.prototype, {
    ...
    dF: function(a) {
      for (var b = 0, c = this.dc.length; b < c; b++)
        this.dc[b].id == a &&
          ((r = this.dc.splice(b, 1)), b--, (c = this.dc.length));
    },
    Ce: function() {
      var a = this;
  ...
  function $b(a) {
    ...
    this.Qi = q;
    this.Zv = p;
    this.DI = new ac({ Of: "api" });
    this.EI = new bc(p, { Of: "api" });
    this.defaultAnchor = Ub;
    this.defaultOffset = new L(10, 10);
    this.rc(a.anchor);
    this.Ce();
  ...
  x.object.extend(cc.prototype, {
    ...
    removeItem: function(a) {
      if (a && "menuitem" == a.Nb) {
        ...
        for (c = this.Hf.length; b < c; b++)
          this.Hf[b] === a && (this.Hf[b].remove(), this.Hf.splice(b, 1), c--);
      }
    },
    TB: function() {
    ...
    fF: function(a) {
      if (this.Ee[a]) {
        for (var b = 0, c = this.ya.length; b < c; b++)
          this.ya[b] &&
            "divider" == this.ya[b].Nb && this.ya[b].Nj == a &&
  ...
  function db(a, b) {
    ...
    a &&
      ((this.Pl = new H(a.lng, a.lat)),
      (this.yl = new H(b.lng, b.lat)),
      (this.Le = a.lng),
      (this.Xd = a.lat),
      (this.He = b.lng),
      (this.Vd = b.lat));
  ...
  x.object.extend(db.prototype, {
    ...
    nb: function(a) {
      return !(a instanceof db) || this.xj()
        ? q
        : this.ve().nb(a.ve()) && this.nf().nb(a.nf());
    },
    ve: u("Pl"),
    nf: u("yl"),
    LV: function(a) {
      return !(a instanceof db) || this.xj() || a.xj()
        ? q
        : a.Le > this.Le && a.He < this.He && a.Xd > this.Xd && a.Vd < this.Vd;
    },
    Ha: function() {
      return this.xj()
        ? p
        : new H((this.Le + this.He) / 2, (this.Xd + this.Vd) / 2);
    },
    mt: function(a) {
      if (
        !(a instanceof db) ||
        Math.max(a.Le, a.He) < Math.min(this.Le, this.He) ||
        Math.min(a.Le, a.He) > Math.max(this.Le, this.He) ||
        Math.max(a.Xd, a.Vd) < Math.min(this.Xd, this.Vd) ||
        Math.min(a.Xd, a.Vd) > Math.max(this.Xd, this.Vd)
      )
        return p;
    ...
    NF: function() {
      return this.xj()
        ? new H(0, 0)
        : new H(Math.abs(this.He - this.Le), Math.abs(this.Vd - this.Xd));
    }
  });
  function H(a, b) {
  ...
  z.We(function(a) {
    ...
    (x.da.la && 8 > x.da.la) || "BackCompat" === document.compatMode
    ...
    a.addEventListener("clearoverlays", function() {
      ...
      a = 0;
      for (var d = b.De.length; a < d; a++)
        b.De[a].enableMassClear !== q &&
          (b.De[a].remove(), (b.De[a] = p), b.De.splice(a, 1), a--, d--);
    });
  ...
  lc.SE = [0.09, 0.005, 1.0e-4, 1.0e-5];
  x.extend(lc.prototype, {
    ...
    jn: function(a, b) {
      b &&
        this.ia[a] &&
        ((this.ff.length = 0), (this.ia[a] = new H(b.lng, b.lat)), this.Eh());
    },
  ...
  x.extend(oc.prototype, {
    Hj: function() {
      ...
      "none" != a.borderColor &&
        c.push("border:" + a.Vx + "px " + a.DY + " " + a.AM + ";");
      c.push(
    ...
    initialize: function(a) {
      ...
      this.Hj();
      this.V &&
        x.M(this.V, G() ? "touchstart" : "mousedown", function(a) {
          ma(a);
        });
      return this.V;
    },
    draw: function() {
      ...
      this.z.za = new L(
        -Math.round(this.z.width / 2) - Math.round(this.z.Vx),
        -Math.round(this.z.height / 2) - Math.round(this.z.Vx)
      );
  ...
  function rc(a, b, c, d) {
    a &&
      ...
      (this.eL = d ? !!d : q),
      (this.Uc = []),
      (this.B_ = a instanceof qc ? a : p),
      (this.JI = b === j ? o : !!(b.indexOf("%") + 1)),
      ...
      (this.KI = !!(c.indexOf("%") + 1)),
      (this.repeat =
        c != j ? (this.KI ? parseFloat(c) / 100 : parseFloat(c)) : 0));
  }
  function sc(a, b) {
    x.lang.Ca.call(this);
    this.content = a;
  ...
  x.extend(tc.prototype, {
    ...
    WN: function(a) {
      this.point = (this.vv = a)
        ? (this.z.position = a.ha())
        : (this.z.position = p);
    },
    ux: function() {
      return this.vv || p;
  ...
  function yc(a, b) {
    var c = this;
    xc() &&
      (a === j && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")),
      "[object Array]" !== Object.prototype.toString.call(a) &&
        ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")),
      (b = b || {}),
      eb.apply(c, arguments),
      (c.ea = { ia: a }),
      (c.z = {
        shape: b.shape || vc,
        size: b.size || wc,
  ...
  x.extend(yc.prototype, {
    initialize: function(a) {
      this.jB && this.jB.push({ method: "initialize", arguments: arguments });
    },
  ...
  x.extend(Bc.prototype, {
    ...
    jn: function(a, b) {
      this.to[a] &&
        ((this.to[a] = new H(b.lng, b.lat)),
        (this.ia[a] = new H(b.lng, b.lat)),
        0 == a &&
          !this.ia[0].nb(this.ia[this.ia.length - 1]) &&
          (this.ia[this.ia.length - 1] = new H(b.lng, b.lat)),
        this.Eh());
    },
    te: function() {
      var a = this.to;
  ...
  x.extend(Fc.prototype, {
    ...
    xf: function() {
      ...
      var a = this;
      this.pE &&
        (this.map.dispatchEvent(new M("onfirsttileloaded")), (this.pE = q));
      0 == this.ph &&
        (this.Li && (clearTimeout(this.Li), (this.Li = p)),
    ...
    Dm: function(a, b, c) {
      ...
      for (d = a.childNodes.length; l < d; l++)
        (w = a.childNodes[l]), (w.kr = q), this.Me.push(w);
      ...
      for (d = this.Me.length; l < d; l++)
        (n = this.Me[l]), n.kr || this.Ne.push(n);
      this.qn = [];
          ...
          m
            ...
            : (0 < this.Ne.length
                ...
                : ((m = document.createElement("canvas")),
                  ...
                  (n.width = e + c + "px"),
                  (n.height = e + c + "px"),
                  this.Rx() && (n.WebkitTransform = "scale(1.001)"),
    ...
    q_: function(a, b, c, d) {
      ...
      k && k.Ib
        ? (ub(k.Ib, b),
          d &&
            ((d = new R(a[0], a[1])),
            (f = this.map.C.xe ? this.map.C.xe.style : "normal"),
        ...
        : (k = this.dj[g]) && k.Ib
        ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild),
          (this.ug[g] = k),
          ub(k.Ib, b),
          d &&
            ((d = new R(a[0], a[1])),
        ...
        : ((k = i * Math.pow(2, f.wm() - a[2])),
          new H(a[0] * k, a[1] * k),
          (d = new R(a[0], a[1])),
          (f = this.map.C.xe ? this.map.C.xe.style : "normal"),
          (d = c.getTilesUrl(d, a[2], f)),
          (k = new Kc(this, d, b, a, c)),
          Jc(k, function() {
            e.xf();
          }),
          k.bo(),
    ...
    tV: function(a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          d = Math.floor(this.mI / c),
          e = Math.floor(this.nI / c),
          c = Math.floor(this.QA / c),
          f = [],
          g = 0;
        g < a.length;
        g++
    ...
    Tf: function(a) {
      ...
      if (b.map.oa() == Pa)
        I.load(
          ...
          function() {
            b.map.Xb ||
              ((b.map.Xb = Pa.tk(b.map.Xg)), (b.map.Jw = Pa.pL(b.map.Xb)));
            b.qI();
          },
          o
        );
      ...
      for (var g = 0; g < c; g++) {
        ...
        if (!i.dI && !((i.rp && !this.map.Wb()) || (i.oM && this.map.Wb()))) {
          ...
          for (A in B) {
            ...
            (C[2] != f ||
              (C[2] == f &&
                (n > C[0] || v <= C[0] || l > C[1] || e <= C[1]))) &&
              this.Jx(E);
          }
          B = -d.offsetX + d.width / 2;
          E = -d.offsetY + d.height / 2;
          i.Rb &&
            ((i.Rb.style.left = Math.ceil(w + B) - t[0] + "px"),
            (i.Rb.style.top = Math.ceil(y + E) - t[1] + "px"),
            (i.Rb.style.WebkitTransform = "translate3d(0,0,0)"));
          w = [];
          for (d.NB = []; n < v; n++)
            for (y = l; y < e; y++) w.push([n, y]), d.NB.push({ x: n, y: y });
  ...
  function Lc(a) {
    if (a) {
      ...
      if (b) {
        d = b.length;
        for (c = 0; c < d; c += 1)
          (e = b[c].name), "unknown" !== typeof a[e] && Xa(a[e]) && (a[e] = p);
      }
      if ((b = a.children)) {
        d = b.length;
  ...
  x.extend(Gc.prototype, {
    ...
    remove: function() {
      this.Rb &&
        this.Rb.parentNode &&
        ((this.Rb.innerHTML = ""), this.Rb.parentNode.removeChild(this.Rb));
      delete this.Rb;
    },
    xt: u("X_"),
    getTilesUrl: function(a, b) {
      if (this.map.oa() !== Ya && this.map.oa() !== Sa)
        var c = this.map.eb.Dw(a.x, b).fs;
      var d = "";
      this.qh.tileUrlTemplate &&
        ((d = this.qh.tileUrlTemplate.replace(/\{X\}/, c)),
        (d = d.replace(/\{Y\}/, a.y)),
        (d = d.replace(/\{Z\}/, b)));
      return d;
    },
  ...
  function lb(a, b) {
    ...
    c.pc = {
      ...
      G_: "png",
      g3: [5, 5, 5, 5],
      AY: { backgroundColor: "#FFFFD5", borderColor: "#808080" },
      Wl: b.ak || pa,
      lu: b.tags || "",
      filter: b.filter || "",
      Ly: b.sortby || "",
  ...
  Yc.getTilesUrl = function(a, b, c) {
    ...
    return (
      ...
      "&scaler=" +
      f +
      (6 == x.da.la ? "&color_dep=32&colors=50" : "") +
      "&udt=" +
      e
    ).replace(/-(\d+)/gi, "M$1");
  };
  ...
  Zc.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.tO[Math.abs(c + d) % this.tO.length] +
      this.map.Xb +
      "/" +
      this.map.Jw +
      "/3/lv" +
  ...
  function td(a, b, c) {
    ...
    if (a) {
      ...
      this.dK = b;
      this.update = o;
      a = { page: 1, Ye: 100, Jd: 100, Uf: 4, WJ: "pg", update: o };
      c || (c = a);
  ...
  x.extend(td.prototype, {
    ...
    VV: function() {
      ...
      this.page > this.Jd - this.Uf &&
        this.page >= this.Uf &&
        ((d = this.Jd - this.Uf + 1), (b = this.Jd));
      for (e = d; e <= b; e++)
        0 < e &&
          (e == this.page
  ...
  var Gd = Fd.prototype;
  T(Gd, { getPoint: Gd.zm, getLocation: Gd.vm });
  ...
  function Na(a, b) {
    function c() {
      e.k.visible
        ? ("inter" === e.Je && e.k.haveBreakId && e.k.indoorExitControl === o
            ? x.K.show(e.xA)
            : x.K.U(e.xA),
          this.k.closeControl && this.yf && this.D && this.D.La() === this.B
            ? x.K.show(e.yf)
            : x.K.U(e.yf),
          this.k.forceCloseControl && x.K.show(e.yf))
        : (x.K.U(e.yf), x.K.U(e.xA));
    }
    ...
    this.Og = [];
    this.zr = [];
    "cvsRender" == this.ck || Ma()
      ? ((this.Vj = 90), (this.Xj = -90))
      : "cssRender" == this.ck && ((this.Vj = 45), (this.Xj = -45));
    this.Dr = q;
    var e = this;
    this.bo = function() {
      this.ck === "flashRender"
    ...
    this.k.RS !== o &&
      (this.bo(), z.En("cus.fire", "count", "z_loadpanoramacount"));
    this.HT(this.B);
  ...
  x.extend(Na.prototype, {
    ...
    Dy: function(a) {
      a !== this.Je &&
        ((this.Je = a), this.dispatchEvent(new M("onscene_type_changed")));
    },
    tc: function(a, b, c) {
    ...
    xB: function() {
      if (this.D)
        for (var a = this.D.yx(), b = 0; b < a.length; b++)
          (a[b] instanceof U || a[b] instanceof tc) &&
            a[b].point &&
            this.wa.push(a[b]);
    },
    vF: ca("D"),
    ...
    er: function() {
      return Ua() && !G() && "javascript" !== this.k.panoramaRenderer
        ? "flashRender"
        : !G() && Kb()
        ? "cvsRender"
        : "cssRender";
  ...
  x.extend(Qd.prototype, {
    ...
    Wn: function() {
      var a = 0,
        ...
        c;
      this.P &&
        ((b = this.P.ha()), (c = this.ha()) && !c.nb(b) && (a = S.Yo(b, c)));
      return a;
    },
    U: function() {
      ba("hide\u65b9\u6cd5\u672a\u5b9e\u73b0");
  ...
  z.Vm(function(a) {
    "flashRender" !== a.er() && new bc(a, { Of: "api" });
  });
  x.extend(bc.prototype, {
    ca: function() {
      function a(a) {
        if (a) {
          ...
          (b.Ya = b.sl), (b.Mb = b.tl), b.dispatchEvent(new M("onnoresult"));
      }
      var b = this.P,
        c = this;
  ...
  x.extend(Zd, {
    nW: function(a, b, c) {
      ...
      b = { data: b };
      "position_changed" == a &&
        (b.data = Zd.Ud.zj(new R(b.data.mercatorX, b.data.mercatorY)));
      c.dispatchEvent(new M("on" + a), b);
    }
  });
  var $d = Zd;
  T($d, { dispatchFlashEvent: $d.nW });
  var ae = { sP: 50 };
  ae.Iu = z.rg("pano")[0];
  ae.Eu = { width: 220, height: 60 };
  x.extend(ae, {
    op: function(a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) d();
      else {
        this.io === j && (this.io = new bc(p, { Of: "api" }));
        var e = this;
        this.io.fC(b, function(b) {
          b
            ? e.io.pj(c.lngLat, ae.sP, function(b) {
                if (b && b.id) {
                  var f = b.id,
                    k = b.rh,
                    b = b.th,
  ...
  function Me(a, b) {
    ...
    c.options.Vk
      ? (c.Pb.style[le] = "translate(" + c.x + "px," + c.y + "px)" + Le)
      : (c.Pb.style.cssText +=
    ...
    this.options.Ex &&
      (Event.prototype.stopImmediatePropagation ||
        ((document.body.removeEventListener = function(a, b, c) {
          ...
          a === "click"
            ? d.call(document.body, a, b.TL || b, c)
  ...
  Me.prototype = {
    ...
    wQ: function() {
      !this.oh &&
        !this.Yk &&
          !(
            this.Zl ||
            (this.Ay == this.Pb.offsetWidth * this.scale &&
              this.Lp == this.Pb.offsetHeight * this.scale)
          ) &&
        this.refresh();
    },
    Kv: function(a) {
      ...
      this[a + "Scrollbar"]
        ? (this[a + "ScrollbarWrapper"] ||
            ((b = be.createElement("div")),
            this.options.mF
              ? (b.className = this.options.mF + a.toUpperCase())
              : (b.style.cssText =
          ...
          "h" == a
            ? ((this.QL = this.RL.clientWidth),
              (this.XX = ce.max(ce.round((this.QL * this.QL) / this.Ay), 8)),
              (this.WX.style.width = this.XX + "px"))
            : ((this.PO = this.QO.clientHeight),
              (this.e0 = ce.max(ce.round((this.PO * this.PO) / this.Lp), 8)),
              (this.d0.style.height = this.e0 + "px")),
          this.rB(a, o))
        : this[a + "ScrollbarWrapper"] &&
          (Be && (this[a + "ScrollbarIndicator"].style[le] = ""),
    ...
    rB: function(a, b) {
      ...
      this[a + "Scrollbar"] &&
        ...
        0 > c
          ? (this.options.tD ||
              ((c = this[a + "ScrollbarIndicatorSize"] + ce.round(3 * c)),
              8 > c && (c = 8),
          ...
          : c > this[a + "ScrollbarMaxScroll"] &&
            (this.options.tD
              ...
              : ((c =
                  ...
                  ce.round(3 * (c - this[a + "ScrollbarMaxScroll"]))),
                8 > c && (c = 8),
                (this[a + "ScrollbarIndicator"].style[
                  "h" == a ? "width" : "height"
                ] = c + "px"),
        ...
        (this[a + "ScrollbarWrapper"].style[we] = "0"),
        (this[a + "ScrollbarWrapper"].style.opacity =
          b && this.options.Ix ? "0" : "1"),
        (this[a + "ScrollbarIndicator"].style[le] =
          "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + Le));
    },
    HQ: function(a) {
    ...
    Tv: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          Ae && 1 < a.touches.length &&
          ((d = ce.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = ce.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.M_ = ce.sqrt(d * d + c * c)),
          (this.iy =
            ce.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.XF) / 2 -
            this.x),
          (this.jy =
            ce.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.YF) / 2 -
            this.y),
          this.options.Bp && this.options.Bp.call(this, a));
        if (
          this.options.$x &&
          (this.options.Vk
            ? ((c = getComputedStyle(this.Pb, p)
                [le].replace(/[^0-9\-.,]/g, "")
                .split(",")),
              (d = +(c[12] || c[4])),
              (c = +(c[13] || c[5])))
            : ((d = +getComputedStyle(this.Pb, p).left.replace(/[^0-9-]/g, "")),
              (c = +getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, ""))),
          d != this.x || c != this.y)
        )
    ...
    fT: function(a) {
      ...
      if (this.options.zoom && Ae && 1 < a.touches.length)
        (e = ce.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (f = ce.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.L_ = ce.sqrt(e * e + f * f)),
          (this.Yk = o),
          (b = (1 / this.M_) * this.L_ * this.scale),
          b < this.options.Xk
            ? (b = 0.5 * this.options.Xk * Math.pow(2, b / this.options.Xk))
            : b > this.options.bq &&
              (b = 2 * this.options.bq * Math.pow(0.5, this.options.bq / b)),
          (this.vp = b / this.scale),
          (e = this.iy - this.iy * this.vp + this.x),
          (f = this.jy - this.jy * this.vp + this.y),
          (this.Pb.style[le] =
            "translate(" + e + "px," + f + "px) scale(" + b + ")" + Le),
        ...
        (6 > this.lw && 6 > this.mw) ||
          (this.options.FE &&
            (this.lw > this.mw + 5
              ? ((f = this.y), (d = 0))
              : this.mw > this.lw + 5 && ((e = this.x), (c = 0))),
          (this.oh = o),
          this.Cr(e, f),
          (this.IC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.JC = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime &&
            ((this.startTime = g), (this.iu = this.x), (this.ju = this.y)),
            ...
            if (300 > i && b.options.$x) {
              ...
              g = e
                ? b.pI(
                    ...
                    i,
                    -b.y,
                    0 > b.nd ? b.Lp - b.zn + b.y - b.qf : 0,
                    b.options.Eo ? b.zn : 0
                  )
                : g;
              d = b.x + f.Ba;
              e = b.y + g.Ba;
              if ((0 < b.x && 0 < d) || (b.x < b.he && d < b.he))
                f = { Ba: 0, time: 0 };
              if ((b.y > b.qf && e > b.qf) || (b.y < b.nd && e < b.nd))
                g = { Ba: 0, time: 0 };
            }
            f.Ba || g.Ba
              ? ((c = ce.max(ce.max(f.time, g.time), 10)),
                b.options.fu &&
                  ((f = d - b.nw),
                  (g = e - b.ow),
                  ce.abs(f) < b.options.Ky && ce.abs(g) < b.options.Ky
                    ? b.scrollTo(b.nw, b.ow, 200)
                    : ((f = b.jJ(d, e)),
                      (d = f.x),
                      (e = f.y),
                      (c = ce.max(f.time, c)))),
                b.scrollTo(ce.round(d), ce.round(e), c))
              : b.options.fu
              ? ((f = d - b.nw),
                (g = e - b.ow),
                ce.abs(f) < b.options.Ky && ce.abs(g) < b.options.Ky
    ...
    ko: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.oh &&
            ((this.oh = q), this.options.gy && this.options.gy.call(this)),
          this.mi &&
            this.options.Ix &&
            ("webkit" == ee && (this.RL.style[we] = "300ms"),
            (this.RL.style.opacity = "0")),
          this.Bi && this.options.Ix)
        )
          "webkit" == ee && (this.QO.style[we] = "300ms"),
    ...
    JU: function(a) {
      ...
      if ("zoom" == b.options.YO) {
        if (
          ...
          d < b.options.Xk && (d = b.options.Xk),
          d > b.options.bq && (d = b.options.bq),
          d != b.scale)
        )
          !b.Uy && b.options.Bp && b.options.Bp.call(b, a),
            b.Uy++,
    ...
    jJ: function(a, b) {
      ...
      a = this.Ue[e];
      d = (d = ce.abs(a - this.Ue[this.zC]))
        ? 500 * (ce.abs(this.x - a) / d)
        : 0;
      this.zC = e;
      e = this.sf.length - 1;
      for (c = 0; c < e; c++)
      ...
      b = this.sf[e];
      c = (c = ce.abs(b - this.sf[this.AC]))
        ? 500 * (ce.abs(this.y - b) / c)
        : 0;
      this.AC = e;
    ...
    refresh: function() {
      ...
      this.wn =
        this.options.wn &&
        ((!this.options.nV && !this.kp) || this.Lp > this.zn);
      ...
      if ("string" == typeof this.options.fu) {
        ...
        for (this.Ue = []; d >= this.he; )
          (this.Ue[b] = d), (d -= this.xu), b++;
        this.he % this.xu &&
          (this.Ue[this.Ue.length] =
            this.he -
            this.Ue[this.Ue.length - 1] +
            this.Ue[this.Ue.length - 1]);
        b = d = 0;
        for (this.sf = []; d >= this.nd; )
          (this.sf[b] = d), (d -= this.zn), b++;
        this.nd % this.zn &&
          (this.sf[this.sf.length] =
            this.nd -
            this.sf[this.sf.length - 1] +
            this.sf[this.sf.length - 1]);
      }
      this.Kv("h");
      this.Kv("v");
    ...
    scrollTo: function(a, b, c, d) {
      var e = a;
      this.stop();
      e.length || (e = [{ x: a, y: b, time: c, qZ: d }]);
      a = 0;
      for (b = e.length; a < b; a++)
        e[a].qZ && ((e[a].x = this.x - e[a].x), (e[a].y = this.y - e[a].y)),
          this.Aj.push({ x: e[a].x, y: e[a].y, time: e[a].time || 0 });
      this.DB();
    },
    disable: function() {
      this.stop();
    ...
    zoom: function(a, b, c, d) {
      ...
      this.options.Vk &&
        ...
        (this.y =
          this.y > this.qf ? this.qf : this.y < this.nd ? this.nd : this.y),
        (this.Pb.style[oe] = d + "ms"),
        (this.Pb.style[le] =
          "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Le),
        (this.Yk = q));
    }
  };
  function ke(a) {
  ...
  z.Vm(function(a) {
    ...
    a.addEventListener("position_changed", function() {
      a.k.visible &&
        a.k.albumsControl === o &&
        (b ? b.uy(a.Zb()) : ((b = new Ne(a.k.albumsControlOptions)), b.ra(a)));
    });
    ...
    a.addEventListener("visible_changed", function() {
      b &&
        (a.bE()
          ? a.k.albumsControl === o && (b.B.style.visibility = "visible")
  ...
  x.extend(Ne.prototype, {
    ...
    uy: function(a, b) {
      if (
        b ||
        !this.$j[this.Xc] ||
        !(this.$j[this.Xc].panoId == a && 3 !== this.$j[this.Xc].recoType)
      ) {
        var c = this,
          d = this.GH(a);
        !b && -1 !== d && this.$j[d] && 3 !== this.$j[d].recoType
          ? this.Pp(d)
          : this.CX(function(a) {
              for (
                ...
                (d = a[m].catlog),
                  ...
                  j !== d &&
                    ("" === d && j !== i
                      ...
                      : (b[Pe[d]] || (b[Pe[d]] = []), b[Pe[d]].push(a[m])));
              for (var t in b)
                k
                  ? l.push({ data: t + "F", index: t })
                  : l.push({ data: Qe[t], index: t });
              c.XG = b;
              c.Ni = l;
              c.Hl(a);
    ...
    WV: function() {
      if (!this.Ki) {
        ...
        new Me(a, { Eo: q, $x: o, mi: q, Bi: q, wn: q, FE: o, Hw: o, Ex: o });
    ...
    TV: function() {
      if (this.Ki) (a = this.oL(this.Ni)), (this.vQ.innerHTML = a);
          ...
          if ((a = (a.srcElement || a.target).getAttribute("dataindex"))) {
            ...
            for (
              ...
              d[e].childNodes[0].getAttribute("dataindex") === a
                ? x.K.Ua(d[e], "pano_catlogLiActive")
        ...
        var a = K("div"),
          ...
          g = K("span"),
          i = [
            "background:url(" + F.qa + "panorama/catlog_icon.png) no-repeat;",
    ...
    UV: function() {
      if (this.Ni && !(0 >= this.Ni.length)) {
        ...
        this.Ki &&
          (this.Ki.style.left =
            parseInt(this.Ki.style.left, 10) + this.dg.width + 8 + "px");
        var b = this;
    ...
    Hl: function(a) {
      ...
      this.k.showCatalog &&
        (0 < this.Ni.length
          ? (Ua() ? this.TV() : this.WV(), (this.Oc.offsetLeft = 60))
          : (this.Ms &&
              (this.B.removeChild(this.Ms),
              (this.Ms = p),
              (this.Oc.eg.style.left = "0px")),
            this.Ki && (this.B.removeChild(this.Ki), (this.Ki = p)),
            (this.Oc.offsetLeft = 0)));
      var b = this.kX(a);
      Ua() &&
        this.Ni && 0 < this.Ni.length && this.k.showExit && this.$z &&
        ((this.Oc.offsetLeft += this.dg.width + 8),
        this.Ms ? (this.Ms.innerHTML = this.$z) : this.UV());
      this.Wh.innerHTML = b;
      this.Wh.style.width = (this.dg.width + 8) * a.length + 8 + "px";
      a = this.B.offsetWidth;
      b = this.Wh.offsetWidth;
      this.Oc.Ts && (b += this.Oc.Ts());
      b < a - 2 * this.Oc.Ei - this.Oc.offsetLeft
        ? (this.B.style.width = b + this.Oc.offsetLeft + "px")
        : ((this.B.style.width =
            isNaN(Number(this.k.maxWidth)) === o
              ? this.k.maxWidth
              : this.k.maxWidth + "px"),
          b < this.B.offsetWidth - 2 * this.Oc.Ei - this.Oc.offsetLeft &&
            (this.B.style.width = b + this.Oc.offsetLeft + "px"));
      this.Oc.refresh();
      this.sB = this.Wh.children;
      this.Wh.appendChild(this.ek);
      this.ek.style.left = "-100000px";
      a = this.GH(this.P.Zb(), this.m1);
      -1 !== a && this.Pp(a);
    },
    qX: function(a) {
    ...
    kX: function(a) {
      for (
        var b, c, d, e, f = [], g = this.dg.height, i = this.dg.width, k = 0;
        k < a.length;
        k++
      )
        (b = a[k]),
          ...
          3 === recoType
            ? Ua()
              ? ((this.$z = b), (this.FW = d), a.splice(k, 1), k--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  k +
                  '"><img style="width:' +
  ...
  Re.prototype = {
    ...
    refresh: function() {
      ...
      this.eg &&
        (this.eg.children[0].style.marginTop = this.Ir.children[0].style.marginTop =
          this.eg.offsetHeight / 2 -
          this.eg.children[0].offsetHeight / 2 +
          "px");
    },
    Ts: function() {
      return 2 * this.Ei;
    ...
    js: function() {
      ...
      this.eg.children[0].style.marginTop = this.Ir.children[0].style.marginTop =
        this.eg.offsetHeight / 2 - this.eg.children[0].offsetHeight / 2 + "px";
    },
    bm: function() {
      var a = this;
    ...
    scrollTo: function(a) {
      a =
        a < this.Rg.offsetLeft
          ? Math.ceil((a - this.Ei - this.fo) / this.Qr) * this.Qr +
            this.fo +
            this.Ei -
            8
          : Math.ceil((a - this.Ei) / this.Qr) * this.Qr + this.Ei;
  ...
  var kf = ib.prototype;
  T(kf, { getUnit: kf.RX, setUnit: kf.AF });
  ...
  var of = Gc.prototype;
  T(of, { getMapType: of.oa, getCopyright: of.tm, isTransparentPng: of.xt });
  var pf = cc.prototype;
  T(pf, { addItem: pf.uw, addSeparator: pf.TB, removeSeparator: pf.fF });
  var qf = fc.prototype;
  T(qf, { setText: qf.Zt });
  var rf = W.prototype;
  T(rf, {
  ...
  xd = wd.prototype;
  T(xd, { setPolicy: xd.Yt, toString: xd.toString, setPageCapacity: xd.Qp });
  T(window, {
